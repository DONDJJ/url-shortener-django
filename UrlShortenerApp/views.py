...
def create_url_view(request,**kwargs):
    ...
    return render(request, 'UrlShortenerApp/create_url.html', {'form':form,'current_user': request.user, 'user_logged_in': request.user.is_authenticated, "prev_url":prev_url})
